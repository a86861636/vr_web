...
import check from '@/views/teacherFunction/exam/components/check'
import cnew from '@/views/teacherFunction/exam/components/new'
import edit from '@/views/teacherFunction/exam/components/edit'
export default {
  name: 'HelloWorld',
  data () {
    return {
